...
class TrojanMap {
 public:
  ...
  std::vector<std::string> FindKClosestPoints_Sort(std::string name, int k);
  std::vector<std::string> FindKClosestPoints_MaxHeap(std::string name, int k);

  
  //----------------------------------------------------- User-defined functions
  //helper function of CalculateShortestPath_Dijkstra
  std::string findMinIDButNotInVisited(std::map<std::string, double> &mindis, 
                                      std::map<std::string, bool> &visited);
                                
  //helper function of TravellingTrojan
  void TravellingTrojanHelper(
            std::vector<std::vector<std::string>> &resP,
            std::vector<std::string> &location_ids,
            std::vector<std::vector<double>> &mapWei,
            std::unordered_set<int> &visited,double &resD, 
            std::vector<int> &curP, double curD);

  //helper function of DeliveringTrojan
  bool DeliveringTrojanHelper(std::string &location,
                    std::unordered_map<std::string,std::vector<std::string>> &neighbors,
                    std::unordered_map<std::string,int> &visited,
                    std::vector<std::string> &result);

  //helper function of CycleDetection
  
void hasCycle(std::string curId, std::vector<std::string>& c,
